        ...
        <section className="wire-page with-sidebar">
            <aside className="sidebar-box">
                ...
                {userRole === 'USER' && (
                    <>
                        ...
                        <button className="side-link" onClick={() => navigate('/suggestions')}>Suggestions</button>
            ...
            <div className="panel-main">
                ...
                <ul className="wire-list">
                    ...
                    {userRole === 'USER' && <li>Review reusing and repurposing suggestions generated by the system.</li>}
                    {userRole === 'USER' && <li>Open View Expert to browse profiles with skill and contact details.</li>}
